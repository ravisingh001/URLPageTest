...
public class TestBase {
	...
	public static void initialization() {
		...
		if (browserName.equals("chrome")) {
			...
			/*
			 * options.addArguments("window-size=1360,768"); DesiredCapabilities cap =
			 * DesiredCapabilities.chrome(); options.
			 * setBinary("C:\\Users\\Rai Sigh\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe"
